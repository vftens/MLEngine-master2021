...
namespace MLEngine.ViewModels
{
    public class ApplicationViewModel : INotifyPropertyChanged
    {
        ...
        public ApplicationViewModel()
        {
            ...
            {
                new MLmodel {TitleModel = "Select Task", FileNameModel = "Select Model File", PostfixModel = "IPC ZeroMQ Channel Name"},
            };
        ...
        public RelayCommand AddModelCommand
        {
            get
            {
                return addModelCommand ?? // присваиваем если null
                  ...
                  {
                      MLmodel mLmodel = new MLmodel() { TitleModel = "Select Task", FileNameModel = "Select Model File", PostfixModel = "IPC ZeroMQ Channel Name" };
